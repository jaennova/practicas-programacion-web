...
function obtenerFuenteEstilo(fuente) {
    ...
    switch (fuente) {
        case '1':
            fuenteCss = "font-family: 'Dancing Script', cursive;";
            break;
        case '2':
            fuenteCss = "font-family: 'Nosifer', sans-serif;";
            break;
        case '3':
            fuenteCss = "font-family: 'Pacifico', cursive;";
            break;
        case '4':
            fuenteCss = "font-family: 'Yuji Hentaigana Akari', cursive;";
            break;
        default:
            fuenteCss = '';
    }
...
const fuente = prompt('Elige la fuente (1. Dancing Script, 2. Nosifer, 3. Pacifico, 4. Yuji Hentaigana Akari)');
